...
const BusquedaEstudiantes = () => {
  ...
  // Lógica para limitar a 6 botones de página
  const maxButtons = 6;
          ...
          {totalPages > 1 && (
            <div className="flex justify-center items-center mt-4 space-x-2">
              ...
              <button
                ...
                className="mx-1 w-10 h-10 flex justify-center items-center rounded text-sm transition bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-white disabled:opacity-50"
              >
                <FaChevronLeft />
              </button>
              {Array.from({ length: endPage - startPage + 1 }, (_, idx) => {
                ...
                return (
                  <button
                    ...
                    className={`mx-1 w-10 h-10 flex justify-center items-center rounded text-sm transition ${
