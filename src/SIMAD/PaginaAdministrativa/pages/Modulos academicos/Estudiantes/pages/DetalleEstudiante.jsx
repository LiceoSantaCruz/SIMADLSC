    ...
    const fetchEstudiante = async () => {
      try {
        ...
        setEstudianteData(
          data.estudiante
            ? data
            : { estudiante: data, encargadoLegal: data.encargadoLegal, seccion: data.seccion }
        );
      } catch (error) {
        Swal.fire({
          icon: 'error',
        ...
        {activeTab === 'estudiante' && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              ['Tipo de Adecuación', studentInfo.tipo_de_adecuacion || 'N/A'],
              ['¿Recibe Religión?', studentInfo.recibe_religion || 'N/A'],
              ['¿Presenta Carta?', studentInfo.presenta_carta || 'N/A'],
              ['Estado', studentInfo.estado_Estudiante || 'Desconocido'],
